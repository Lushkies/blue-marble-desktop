; Desktop Earth - Inno Setup Script (x64)
...
OutputBaseFilename=DesktopEarth-{#MyAppVersion}-x64-setup
...
Source: "..\publish\x64\DesktopEarth.exe"; DestDir: "{app}"; Flags: ignoreversion
